...
export default class ClienteController {
    ...
    async listarClientes(): Promise<{ status: number; body: Cliente[] | { message: string } }> {
        try {
    ...
    async criarCliente(request: Request): Promise<{ status: number; body: { cpf: string } | { message: string } }> {
